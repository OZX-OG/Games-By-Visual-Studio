...
namespace Car_Game
{
    public partial class Form_Hard_Move_Mode : Form
    {
        public Form_Hard_Move_Mode()
        {
            InitializeComponent();
        }
        ///////Var
        ...
        private void Form_Hard_Move_Mode_KeyDown(object sender, KeyEventArgs e)
        {

            {
                ...
                {
                    if (e.KeyData == Keys.Space || e.KeyData == Keys.Enter || e.KeyData == Keys.Escape || e.KeyData == Keys.P || e.KeyData == Keys.Up || e.KeyData == Keys.Left || e.KeyData == Keys.Right)
                    {
                        lblPause.Visible = false;
                        lblPausee.Visible = false;
        ...
        private void Form_Hard_Move_Mode_KeyUp(object sender, KeyEventArgs e)
        {
            dir = Dir.None;
        }
