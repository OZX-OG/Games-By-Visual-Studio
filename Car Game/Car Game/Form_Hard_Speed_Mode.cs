...
namespace Car_Game
{
    public partial class Form_Hard_Speed_Mode : Form
    {
        public Form_Hard_Speed_Mode()
        {
            InitializeComponent();
        }
        ...
        private void FormHardSpeedGame_KeyDown(object sender, KeyEventArgs e)
        {
            ////Move
        ...
        private void FormHardSpeedGame_KeyUp(object sender, KeyEventArgs e)
        {
            dir = Dir.None;
        }
